                ...
                <div class="p-6 text-gray-900">
                    <form wire:submit.prevent="save">
                        <div>
                            ...
                            <x-text-input wire:model.lazy="quiz.title" id="title" class="block mt-1 w-full" type="text"
                                          name="title" required/>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model.lazy="quiz.slug" id="slug" class="block mt-1 w-full" type="text"
                                          name="slug"/>
                        ...
                        <div class="mt-4">
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" id="published" class="mr-1 ml-2"
                                       wire:model.defer="quiz.published">
                            </div>
